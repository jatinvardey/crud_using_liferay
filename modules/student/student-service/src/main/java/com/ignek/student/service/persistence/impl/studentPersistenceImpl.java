...
package com.ignek.student.service.persistence.impl;

import com.ignek.student.exception.NoSuchentException;
import com.ignek.student.model.impl.studentImpl;
import com.ignek.student.model.impl.studentModelImpl;
import com.ignek.student.model.student;
import com.ignek.student.service.persistence.impl.constants.studPersistenceConstants;
...
public class studentPersistenceImpl
	 ...
	 * @throws NoSuchentException if a matching student could not be found
	 */
	@Override
	public student findByUuid_First(
			String uuid, OrderByComparator<student> orderByComparator)
		throws NoSuchentException {
		...
		throw new NoSuchentException(sb.toString());
	}
	 ...
	 * @throws NoSuchentException if a student with the primary key could not be found
	 */
	@Override
	...
	/**
	 * Returns the student where uuid = &#63; and groupId = &#63; or throws a <code>NoSuchentException</code> if it could not be found.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public student remove(long studentId) throws NoSuchentException {
	 ...
	 */
	@Override
	public student remove(Serializable primaryKey) throws NoSuchentException {
		Session session = null;
		...
		try {
			...
			if (student == null) {
				...
				throw new NoSuchentException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(student);
		}
		catch (NoSuchentException noSuchEntityException) {
	...
	/**
	 * Returns the student with the primary key or throws a <code>NoSuchentException</code> if it could not be found.
	 *
	 * @param studentId the primary key of the student
	 * @return the student
	 * @throws NoSuchentException if a student with the primary key could not be found
	 */
	@Override
	public student findByPrimaryKey(long studentId) throws NoSuchentException {
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.ignek.student.model.student"),
			true);
	}
